...
val allMovies: List<Movie> =
    listOf(
        Movie("Wyspa Tajemnic",
            ...
            listOf(Trailer("Oficjalny Zwiastun" ,"wyspa_tajemnic_trailer1"), Trailer("Zwiastun Telewizyjny" ,"wyspa_tajemnic_trailer2"))
        ),
        Movie("Bękarty Wojny",
            "bekarty_wojny_cover",
            ...
            listOf(Trailer("Oficjalny Zwiastun #1" ,"bekarty_wojny_trailer1"), Trailer("Oficjalny Zwiastun #2" ,"bekarty_wojny_trailer2"), Trailer("Oficjalny Zwiastun #3" ,"bekarty_wojny_trailer3"))),
        Movie("Baby Driver",
            "baby_driver_cover",
            ...
            listOf(Trailer("Oficjalny Zwiastun" ,"baby_driver_trailer1"), Trailer("Zwiastun - TeKillYah" ,"baby_driver_trailer2"))),
    )